...
for site in sites:
    gas_a = np.random.default_rng().uniform(2000, 2400, n_dates)
    gas_b = np.random.default_rng().uniform(2000, 2400, n_dates)
    gas_c = np.random.default_rng().uniform(2000, 2400, n_dates)
